...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference("Notification.count") do
      post notifications_url, params: { notification: { appointment_id_id: @notification.appointment_id_id, message: @notification.message } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { appointment_id_id: @notification.appointment_id_id, message: @notification.message } }
